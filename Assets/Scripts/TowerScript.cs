...
public class TowerScript : MonoBehaviour
{
    ...
    [Range(0f, 2f)][SerializeField] private float zGap;
    ...
    public static TowerScript towerScriptInstance;
    private bool isTowerCreated;
    public int towerCount;

    public bool IsTowerCreated => isTowerCreated;
    private void Start()
    {
        towerScriptInstance = this;
    }
    private void TowerCreated()
    {
        isTowerCreated = true;
        towerCount = towerList.Count;
    }
    ...
    IEnumerator BuildTowerCoroutine()
    {
            ...
            foreach (int towerHumanCount in towerCountList)
            {
                ...
                {
                    child.transform.DOLocalMove( child.transform.localPosition + new Vector3(0, yGap, zGap), 0.2f).SetEase(Ease.OutQuad);
                }
